...
import com.tuzhi.application.databinding.ItemChooseKnowledgeChannelBinding;
...
public class ChooseChannelItem extends BaseItem<ChooseColleagueItemBean> {

    public static final String TYPE = "ChooseChannelItem";

    private ItemChooseKnowledgeChannelBinding binding;
    ...
    public int getLayoutResId() {
        return R.layout.item_choose_knowledge_channel;
    }
