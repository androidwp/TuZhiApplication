...
public class AESUtils {
	private static final String	AES_KEY	= "duew&^%5d54nc'KH";
	...
	public static String decode(String hex) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
			IllegalBlockSizeException, BadPaddingException {
		String rr = "";
